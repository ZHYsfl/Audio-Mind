#!/usr/bin/env python3
"""Quick environment test for lv-chordia tool."""
...
def test_imports():
    ...
    try:
        ...
        print("  ✓ lv_chordia.chord_recognition imported")
    except ImportError as e:
        print(f"  ✗ lv_chordia: {e}")
        return False
    try:
        import soundfile
...
def test_inference():
    """Test minimal inference on a generated sine wave."""
    print("\nTesting inference...")
    # Generate a simple test audio file
    try:
        import numpy as np
        import soundfile as sf
        audio_path = "/tmp/lv_chordia_test_chord.wav"
        sr = 22050
    ...
    try:
        from model import ModelWrapper
        wrapper = ModelWrapper()
        result = wrapper.predict(audio_path, chord_dict_name="ismir2017")
...
def main():
    """Run all tests."""
    print("=" * 60)
    print("lv-chordia Tool Environment Test")
    print("=" * 60)
    print()
